...
public class Admin_TienThuong extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnTienThuong.setBounds(670, 110, 280, 70);
        ...
        btnNguoiDung.setBounds(70, 110, 300, 70);
        ...
        btnCauHoi.setBounds(370, 110, 300, 70);
        ...
        jLabel11.setBounds(300, 340, 90, 50);

        jLabel9.setText("Câu");
        getContentPane().add(jLabel9);
        jLabel9.setBounds(300, 270, 70, 50);
        ...
        txtDapAn_A.setBounds(390, 270, 270, 50);
        getContentPane().add(txtDapAn_B);
        txtDapAn_B.setBounds(390, 340, 270, 50);
